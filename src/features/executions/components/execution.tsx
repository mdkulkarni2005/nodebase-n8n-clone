    ...
    <Card className="shadow-none">
      ...
      <CardContent className="space-y-4">
        <div className="grid grid-cols-2 gap-4">
          ...
          {execution.error && (
            <div className="mt-6 p-4 bg-red-50 rounded-md space-y-3 border border-red-200">
              <div>
                <p className="text-sm font-medium text-red-900 mb-2">Error</p>

                {/* auto-small if short, auto-... if long */}
                <p className="text-sm text-red-800 font-mono whitespace-pre-wrap break-words line-clamp-3">
                  {execution.error}
                </p>
              </div>
